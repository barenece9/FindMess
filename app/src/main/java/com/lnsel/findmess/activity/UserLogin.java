...
public class UserLogin extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_registetion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(UserLogin.this,UserRegistetionActivity.class));
                finish();
            }
        });
            ...
            public void onClick(View view) {
               ...
               // finish();
                ...
                if(user.equalsIgnoreCase("")){
                    CreateDialog.showDialog(UserLogin.this,"Enter username");
                }else if(password.equalsIgnoreCase("")){
                    CreateDialog.showDialog(UserLogin.this,"Enter password");
                }else {
                    doLogin();
                }
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(UserLogin.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_LONG).show();
                    }
                }
        ){
            @Override
    ...
    public void JSONresponse(String responsedata){
        ...
        try {
            ...
            if(status.equalsIgnoreCase("true")){
                ...
                Sharepreferences.setUserinfo(UserLogin.this,user_id,name);
                startActivity(new Intent(UserLogin.this,FindActivity.class));
                finish();
            }else {
